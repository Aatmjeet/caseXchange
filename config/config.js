...
module.exports = {
    ...
    bots: {
        /*bot_1: {
            ...
            accountName: 'casexchangebot',    // bot_1 username
            password: 'casexchange',       // bot_1  password
            twoFactorCode: '2SqtLAeuYkzQMyWCHo3GUmcJjR8',  // shared_secret value
            identitySecret: 'oudBnieaT0cSUYUG696UbUp23/U=', // identity_secret value
            steamID64: '76561199064313370',  // SteamID64 of bot account can be found here: "https://steamid.io/"
            personaName: 'caseXchangebot#1',   // Nickname for bot account, will change on restart
            tradeUrl: 'https://steamcommunity.com/tradeoffer/new/?partner=1104047642&token=xsgSODyI'
        },*/
        bot_1: {
            siteName: 'Bot 1',  // Will be displayed under the "All bots" tab e.g. "Keys Only"
            ...
            steamID64: '76561199038437498',  // SteamID64 of bot account can be found here: "https://steamid.io/"
            personaName: 'caseXchangebot#1',   // Nickname for bot account, will change on restart
            //tradeUrl: 'https://steamcommunity.com/tradeoffer/new/?partner=1104047642&token=xsgSODyI'
        },
